...
def main():
    ...
    #NEW
    choicePairs = list()
    buttonSetup = [(310, 350, 'red'), (310, 310, 'yellow'), (310, 270, 'blue'), (310,230, 'green'),(310,190, 'purple')]
    ...
    chimney = makeColoredRect(Point (190,300), 30,100, 'gray',win)
    ...
    #NEW
    shapePairs = [(house, 'house'), (door, 'door'), (roof, 'roof'), (chimney, 'chimney')] 
